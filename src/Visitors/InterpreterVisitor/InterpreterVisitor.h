...
private:
    ...
    std::optional<dec::decimal<MAX_DECIMAL_POINTS>> currentValue;
    std::optional<std::string> stringSpecialValue;
    std::optional<std::string> currentCurrencyIdentifier;
    std::optional<std::unordered_map<std::string,dec::decimal<MAX_DECIMAL_POINTS>>> currentCurrencyDenominations;

public:
    InterpreterVisitor(Program &program, std::string mainFunctionName, std::unordered_map<std::string, std::unordered_map<std::string,dec::decimal<MAX_DECIMAL_POINTS>>> curMap);
    ...
    std::optional<dec::decimal<MAX_DECIMAL_POINTS>> tryBuildNumber(std::string num);
};